...
#  Default: '/usr/local/Caskroom/miniforge/base/envs/jupyter/etc/jupyter/lab/workspaces'
# c.LabApp.workspaces_dir = '/usr/local/Caskroom/miniforge/base/envs/jupyter/etc/jupyter/lab/workspaces'
